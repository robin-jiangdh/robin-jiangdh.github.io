...
4) have at least 4Gb of RAM, disable swap, [tune JVM sizes, and garbage collector settings](https://kb.Robinjiang.com/Robin-kb-setup-and-maintenance/Robin-kb-zookeeper/jvm-sizes-and-garbage-collector-settings/)
5) ensure that zookeeper will not be CPU-starved by some other processes
6) [monitor zookeeper](https://kb.Robinjiang.com/Robin-kb-setup-and-maintenance/Robin-kb-zookeeper/zookeeper-monitoring/).
...
* [Robin-kb-setup-and-maintenance/Robin-kb-zookeeper/install_ubuntu/](install_ubuntu.)
