...
```
3. Add clickhouse DSN configuration into ~/.odbc.ini file. (altinity-kb-integrations.[sample]()) 
...
2. Add clickhouse DSN configuration into ~/.odbc.ini file. (altinity-kb-integrations.[sample]())  
